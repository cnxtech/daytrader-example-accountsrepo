...
#### Create a Deployment to run the application in one or more pods
    ...
    Notes: A Deployment also creates the specified number of PODs and a ReplicaSet to manage the lifecycle of the pods
	    ...
	    1.  $ cd daytrader-accountsapp\daytrader-accounts\env\external\k8s
		...
		3.  $ kubectl get pods
            ...
            daytrader-accounts-87b5658f4-889gp  1/1     Running   0          6m   
        ...
        4.  $ kubectl logs <POD_NAME>
            ...
            ##  You should see : Tomcat started on port(s): 1443 (https). If not see Troubleshooting
...
#### Create a Service to load balance requests across the Pods
	...
	communicate with application's directly. Instead they should talk to applications via service. To create the service,
        ...
        2.  $ kubectl get services
            ...
            daytrader-accounts	ClusterIP   10.100.17.24     <none>        443/TCP         3d
...
### Pods
        ...
        2.  Access the pod (application) through the port forwarder
	            ...
	            a.	$ kubectl port-forward <POD_NAME> 8888:1443  ## This command forwards local port 8888 to port 1443 of your pod
       
        	    	Forwarding from 127.0.0.1:8888 -> 1443
...
### Services
        ...
        1.	Access the service (application) through the API Server
    			...
    			b.	$ curl -k http://localhost:8001/api/v1/namespaces/default/services/https:daytrader-accounts:/proxy/health      
...
#### Local
   		...
   		1. Make sure the application is running
     			...
     			$ cd daytrader-accountsapp
       			$ daytrader-accounts\env\external\bin\start_server
	    ...
	    3.	Stop the application after reviewing the APIs
      			...
      			$ cd daytrader-accountsapp	
            	$ daytrader-accounts\env\external\bin\stop_server
