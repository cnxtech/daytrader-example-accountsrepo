...
#### Create the deployment, replica set, and pod(s) to run the application
		...
		2.	$ kubectl apply -f daytrader-accounts-deployment.yaml 
...
#### Create the service so clients can communicate with pods via a constant IP
        ...
        To create the service,
            ...
            1.  $ kubectl apply -f daytrader-accounts-service.yaml
        ...
        Access the service indirectly (via  the API Server)
            ...
            2.  $ curl -k http://localhost:8001/api/v1/namespaces/default/services/https:daytrader-accounts:/proxy/health
                ...
                ## Accesses the accounts service through the API Server.       
